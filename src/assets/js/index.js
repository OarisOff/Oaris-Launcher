...
class Splash {
    ...
    async startAnimation() {
        let splashes = [
    { "message": "Le T-Rex avait de très petits bras.", "author": "Oaris" },
    { "message": "Certains dinosaures avaient des plumes.", "author": "Proximity" },
    { "message": "Le Triceratops avait trois cornes.", "author": "Oaris" },
    { "message": "Le Brachiosaure pouvait mesurer 13 mètres.", "author": "Proximity" },
    { "message": "Les oiseaux descendent des dinosaures.", "author": "Oaris" },
    { "message": "Le Velociraptor était très rapide.", "author": "Proximity" },
    { "message": "Le Spinosaurus aimait l’eau.", "author": "Oaris" },
    { "message": "Le Stegosaurus avait une queue piquante.", "author": "Proximity" },
    { "message": "Les dinosaures vivaient sur tous les continents.", "author": "Oaris" },
    { "message": "Le Diplodocus avait un long cou.", "author": "Proximity" }
        ];
